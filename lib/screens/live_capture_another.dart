...
class AnotherLiveCapture extends StatefulWidget{

  State<AnotherLiveCapture> createState()=> AnotherLiveCaptureState();
}
class AnotherLiveCaptureState extends State<AnotherLiveCapture>{
